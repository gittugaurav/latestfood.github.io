    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, foodname, price,  quantity, order_date, username, R_ID) 
      ...
      if(!$success)
      {
        ...
        <div class="container">
          <div class="jumbotron">
            <h1><center>PAY HERE !!!</center></h1>
          </div>
        </div>
        <br>
<h1 class="text-center">Total Amount: &#8377;<?php echo "$gtotal"; ?>/-</h1>
...
<h1 class="text-center">
  ...
  <a href="pay.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Scan and Pay</button></a>
</h1>
